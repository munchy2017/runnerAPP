...
<!-- Mirrored from truelysell-html.dreamguystech.com/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Oct 2020 15:04:01 GMT -->
<head>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0">
	<title>RunnersApp</title>
		...
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo logo-small">
					<img src="assets/img/logo1.png" alt="Logo" width="30" height="30">
				</a>
			</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<div class="dash-widget-info">
										<h3>148</h3>
										<h6 class="text-muted">Runners</h6>
									</div>
								</div>
							</div>
						</div>
